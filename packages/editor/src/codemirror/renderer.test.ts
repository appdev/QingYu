...
describe("QingYu renderers", () => {
  ...
  it("requires renderers to declare stable identifiers and node names", () => {
    ...
    ).toThrow('QingYu renderer "synthetic.empty" must declare a node name');
  });
});
