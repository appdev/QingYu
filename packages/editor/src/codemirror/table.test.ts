...
describe("tablePreviewPlugin", () => {
  ...
  it("renders the original QingYu table control layout and icons", () => {
    const doc = [
      "| Name | Value |",
      "| :--- | :--- |",
      "| Alpha | 1 |",
  ...
  it("applies QingYu's configured table width mode", () => {
    const doc = [
      "| Name | Value |",
      "| --- | --- |",
      "| Alpha | 1 |",
  ...
  it("resizes a table and keeps editing in the last visual cell", async () => {
    ...
    expect(view.state.doc.toString()).toContain("| Name | QingYu |  |");
