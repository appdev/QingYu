...
export function generateDiagnosticsReport({
  ...
  return [
    ...
    line("Local file import enabled", features.localFileImport),
    ...
    line("Standalone documents enabled", features.standaloneDocuments),
    line("System fonts enabled", features.systemFonts),
    line("Template mutation enabled", features.templateMutation),
