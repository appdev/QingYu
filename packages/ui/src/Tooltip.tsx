        ...
        ? createPortal(
            <div
              ...
              className={mergeClassNames(
                "pointer-events-none fixed z-50 max-w-[min(28rem,calc(100vw-1rem))] rounded-md border border-(--border-default) bg-(--bg-primary) px-2 py-1 text-[11px] leading-4 font-[520] break-words text-(--text-heading) shadow-(--floating-popover-shadow)",
                className
              )}
              id={tooltipId}
              role="tooltip"
