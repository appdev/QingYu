...
var (
	...
	BasicAuthHeaderValue = "Basic realm=\"QingYu Authorization Required\", charset=\"UTF-8\""
)
...
func CheckAuth(c *gin.Context) {
	...
	if workspaceSession.AccessAuthCode != Conf.AccessAuthCode {
		...
		if util.IsNativeAppUserAgent(userAgentHeader) || strings.HasPrefix(userAgentHeader, "Mozilla/") {
