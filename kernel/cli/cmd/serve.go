...
func init() {
	...
	serveCmd.Flags().StringVar(&serveWdPath, "wd", resolveWorkingDir(), "working directory of QingYu")
	...
	serveCmd.Flags().BoolVar(&serveEnablePprof, "enable-pprof", false, "register authenticated /debug/pprof/ endpoints")
