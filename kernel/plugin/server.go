...
type RequestUrl struct {
	...
	Host            string       `json:"host"`     // e.g. 127.0.0.1:9806
...
type RequestContent struct {
	...
	Referer       string `json:"referer"`       // e.g. "http://127.0.0.1:9806/stage/build/app/"
	UserAgent     string `json:"userAgent"`     // e.g. "QingYu/3.7.3 Electron Mozilla/5.0 (Windows NT 10.0; Win64; x64)"
