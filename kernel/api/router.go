...
func ServeAPI(ginServer *gin.Engine) {
	...
	ginServer.Handle("POST", "/api/system/setMCP", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, setMCP)
	...
	ginServer.Handle("POST", "/api/storage/getMarkdownTableAppearance", model.CheckAuth, getMarkdownTableAppearance)
	ginServer.Handle("POST", "/api/storage/patchMarkdownTableAppearance", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, patchMarkdownTableAppearance)
	ginServer.Handle("POST", "/api/storage/migrateMarkdownTableAppearance", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, migrateMarkdownTableAppearance)
	ginServer.Handle("POST", "/api/storage/removeMarkdownTableAppearance", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, removeMarkdownTableAppearance)
	...
	ginServer.Handle("POST", "/api/notebook/listRootDocuments", model.CheckAuth, listNotebookRootDocuments)
	ginServer.Handle("POST", "/api/notebook/prepareDocumentCardPreview", model.CheckAuth, prepareDocumentCardPreview)
	ginServer.Handle("POST", "/api/notebook/storeDocumentCardPreview", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, storeDocumentCardPreview)
	ginServer.Handle("GET", "/card-preview/:notebook/:cacheKey", model.CheckAuth, getDocumentCardPreview)
	...
	ginServer.Handle("POST", "/api/markdown/create", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, createMarkdown)
	ginServer.Handle("POST", "/api/markdown/get", model.CheckAuth, model.CheckAdminRole, getMarkdown)
	ginServer.Handle("POST", "/api/markdown/save", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, saveMarkdown)
	ginServer.Handle("POST", "/api/markdown/ensureDocumentIdentity", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, ensureMarkdownDocumentIdentity)
	ginServer.Handle("POST", "/api/markdown/rename", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, renameMarkdown)
	ginServer.Handle("POST", "/api/markdown/duplicate", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, duplicateMarkdown)
	ginServer.Handle("POST", "/api/markdown/move", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, moveMarkdown)
	ginServer.Handle("POST", "/api/markdown/remove", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, removeMarkdown)
	ginServer.Handle("POST", "/api/markdown/listDeleted", model.CheckAuth, model.CheckAdminRole, listDeletedMarkdown)
	ginServer.Handle("POST", "/api/markdown/getDeleted", model.CheckAuth, model.CheckAdminRole, getDeletedMarkdown)
	ginServer.Handle("POST", "/api/markdown/restore", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, restoreDeletedMarkdown)
	ginServer.Handle("POST", "/api/markdown/purgeDeleted", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, purgeDeletedMarkdown)
	...
	ginServer.Handle("POST", "/api/asset/ackMarkdownSaveBarrier", model.CheckAuth, ackMarkdownSaveBarrier)
	...
	ginServer.Handle("POST", "/api/export/exportMarkdownDocumentZip", model.CheckAuth, model.CheckAdminRole, exportMarkdownDocumentZip)
	ginServer.Handle("POST", "/api/export/exportMarkdownPreview", model.CheckAuth, model.CheckAdminRole, exportMarkdownDocumentPreview)
	ginServer.Handle("POST", "/api/export/exportMarkdownHTML", model.CheckAuth, model.CheckAdminRole, exportMarkdownDocumentHTML)
	ginServer.Handle("POST", "/api/export/exportMarkdownDocx", model.CheckAuth, model.CheckAdminRole, exportMarkdownDocumentDocx)
	ginServer.Handle("POST", "/api/export/processMarkdownPDF", model.CheckAuth, model.CheckAdminRole, processMarkdownDocumentPDF)
	ginServer.Handle("POST", "/api/export/exportMarkdownPandoc", model.CheckAuth, model.CheckAdminRole, exportMarkdownDocumentPandoc)
	...
	ginServer.Handle("POST", "/api/template/markdownSaveAsTemplate", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, saveMarkdownDocumentAsTemplate)
