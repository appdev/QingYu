...
const debName = `QingYu_${releaseVersion}_linux_x64.deb`;
...
const pkgbuild = `pkgname=qingyu
pkgver=${packageVersion}
pkgrel=1
pkgdesc='Practical Markdown note-taking editor'
arch=('x86_64')
url='https://github.com/appdev/QingYu'
license=('AGPL-3.0-only')
depends=('gtk3' 'libayatana-appindicator' 'webkit2gtk-4.1')
conflicts=('qingyu-bin')
options=('!strip' '!debug')
source=('${debName}')
noextract=('${debName}')
