...
* Parameters
  ...
  ```json
  {
    ...
    "path": "F:\\QingYu\\data\\templates\\foo.md"
  }
  ```
...
* Parameters
  ...
  ```json
  {
    "template": "/documents/{{now | date \"2006/01\"}}/{{now | date \"2006-01-02\"}}"
  }
  ```
...
* Return value
  ...
  ```json
  {
    "code": 0,
    "msg": "",
    "data": "/documents/2023/03/2023-03-24"
  }
  ```
...
* Return value
  ...
  ```json
  {
    ...
    "data": {
      ...
      "content": "## 🍫 Content Block\n\nIn QingYu, the only important core concept is..."
    }
  }
  ```
