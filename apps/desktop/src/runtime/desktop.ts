...
export const desktopRuntime = {
  ...
  syncConfig: {
    ...
    listConflicts: syncConfig.listNativeDejavuConflicts,
    ...
    readConflict: syncConfig.readNativeDejavuConflict,
    ...
    resolveConflict: syncConfig.resolveNativeDejavuConflict,
