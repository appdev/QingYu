...
* Windows:
  ...
  * `go build -tags "fts5 sqlcipher" -o "../app/kernel/QingYu-Kernel.exe"`
* Linux/macOS: `go build -tags "fts5 sqlcipher" -o "../app/kernel/QingYu-Kernel"`
* `cd ../app/kernel`
* Windows: `./QingYu-Kernel.exe serve --mode=dev`
* Linux/macOS: `./QingYu-Kernel serve --mode=dev`
