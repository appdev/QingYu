...
const I18N_BASE = {
    ...
    "en": {
        ...
        slogan: "Clear windows, a quiet desk, words softly spoken.",
        wsTitle: "Workspaces",
    ...
    "ar": {
        ...
        slogan: "نوافذ مضيئة، مكتب هادئ، وكلمات تُقال برفق",
    ...
    "de": {
        ...
        slogan: "Helle Fenster, ein stiller Schreibtisch, sanft gesetzte Worte.",
    ...
    "es": {
        ...
        slogan: "Ventanas luminosas, un escritorio sereno, palabras dichas en voz baja.",
    ...
    "fr": {
        ...
        slogan: "Fenêtres claires, bureau paisible, mots murmurés.",
    ...
    "he": {
        ...
        slogan: "חלונות מוארים, שולחן שקט, מילים הנאמרות ברכות.",
    ...
    "hi": {
        ...
        slogan: "उजली खिड़कियाँ, शांत मेज़, हर शब्द धीमे से कहा गया।",
        wsTitle: "वर्कस्पेस",
    ...
    "id": {
        ...
        slogan: "Jendela terang, meja tenang, kata-kata yang terucap lembut.",
        wsTitle: "Ruang Kerja",
    ...
    "it": {
        ...
        slogan: "Finestre luminose, una scrivania quieta, parole sussurrate.",
    ...
    "nl": {
        ...
        slogan: "Heldere ramen, een rustige schrijftafel, zacht gesproken woorden.",
        wsTitle: "Werkruimten",
    ...
    "pl": {
        ...
        slogan: "Jasne okna, spokojne biurko, słowa wypowiadane cicho.",
    ...
    "pt-BR": {
        ...
        normalBtn: "Iniciar normalmente",
        slogan: "Janelas claras, uma mesa serena, palavras ditas suavemente.",
    ...
    "ru": {
        ...
        slogan: "Светлые окна, тихий стол, слова, сказанные вполголоса.",
    ...
    "sk": {
        ...
        slogan: "Svetlé okná, pokojný stôl, slová vyslovené potichu.",
    ...
    "th": {
        ...
        slogan: "หน้าต่างสว่าง โต๊ะสงบ ถ้อยคำแผ่วเบา",
    ...
    "tr": {
        ...
        slogan: "Aydınlık pencereler, sakin bir masa, usulca söylenen sözler.",
    ...
    "uk": {
        ...
        slogan: "Світлі вікна, тихий стіл, слова, сказані пошепки.",
...
const chooseWorkspacePath = async (langData) => {
    ...
    let defaultWorkspace = path.join(decodeURIComponent(getSearch("home")), "QingYu");
    if ("darwin" === process.platform) {
        // Change the initial workspace path to ~/Library/Application Support/QingYu on macOS https://github.com/siyuan-note/siyuan/issues/17095
        defaultWorkspace = path.join(decodeURIComponent(getSearch("home")), "Library", "Application Support", "QingYu");
    }
