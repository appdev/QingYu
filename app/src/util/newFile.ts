...
export function getNewFilePath(): Pick<NewDocRequest, "notebookId" | "currentPath" | "hasFocusTarget"> {
    let notebookId = "";
    let currentPath = "";
    ...
    if (tab?.model instanceof Editor) {
        ...
        currentPath = pathPosix().dirname(tab.model.path);
        hasFocusTarget = true;
    }
    if (!notebookId) {
        ...
        if (fileModel instanceof Files) {
            ...
            if (currentElement) {
                ...
                if (currentElement.getAttribute("data-doc-type") === "markdown") {
