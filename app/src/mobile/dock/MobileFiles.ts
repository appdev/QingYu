            ...
            while (target && !target.isEqualNode(this.actionsElement)) {
                ...
                if (type === "refresh") {
                    ...
                    if (target.getAttribute("data-doc-type") === "markdown") {
                        openMobileMarkdownFile(app, notebookId, target.getAttribute("data-path"), target.getAttribute("data-name"));
                    } else if (target.getAttribute("data-type") === "navigation-file") {
