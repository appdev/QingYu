...
export const markraTheme = EditorView.baseTheme({
  ...
  ".cm-markra-link": {
    color: "var(--b3-markdown-link-color, var(--b3-theme-primary, #2563eb))",
  ...
  ".cm-markra-highlight": {
    backgroundColor: "var(--b3-markdown-highlight-background-color, var(--b3-protyle-inline-mark-background, color-mix(in srgb, #facc15 38%, transparent)))",
    borderRadius: "0.16em",
    padding: "0 0.06em",
  },
  ...
  ".cm-markra-task-checkbox": {
    accentColor: "var(--b3-theme-primary, #2563eb)",
    cursor: "pointer",
    height: "1em",
    margin: "0 0.45em 0 0",
